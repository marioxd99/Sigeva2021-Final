define([ 'knockout', 'appController', 'ojs/ojmodule-element-utils', 'accUtils',
	...
	class ModCitaViewModel {
		constructor() {
			...
			var final2 = fSegunda.toISOString().slice(0, 10);
		...
		modificarCita() {
			...
			let data = {
					...
					error: function(response) {
						var respuesta = response.responseJSON.message;
						$.confirm({title: 'Error',content: respuesta,type: 'red',typeAnimated: true,buttons: {tryAgain: {text: 'Cerrar',btnClass: 'btn-red',action: function(){}}}});
					}
			};
			$.ajax(data);
		}
