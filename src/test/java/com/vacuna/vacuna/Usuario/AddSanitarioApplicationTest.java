...
public class AddSanitarioApplicationTest {
	@Autowired
	...
	@Test
	@Order(1)
	public void saveSanitarioCorrecto() throws Exception {
	...
	@Test
	public void expectedErrorSanitarioExistente() throws Exception {
		JSONObject json = new JSONObject();
		json.put("nombre", TEST_NOMBRE);
		json.put("email", TEST_EMAIL);
		json.put("password", TEST_PASSWORD);
