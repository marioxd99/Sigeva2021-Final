...
public class AddAdministradorApplicationTest {
	@Autowired
	...
	@Test
	@Order(1)
	public void saveAdministradorCorrecto() throws Exception {
	...
	@Test
	public void expectedErrorDniNombreVacios() throws Exception {
		JSONObject json = new JSONObject();
		json.put("nombre", "");
		json.put("email", TEST_EMAIL);
		json.put("password", TEST_PASSWORD);
	...
	@Test
	public void expectedErrorAdministradorExistente() throws Exception {
		JSONObject json = new JSONObject();
		json.put("nombre", TEST_NOMBRE);
		json.put("email", TEST_EMAIL);
		json.put("password", TEST_PASSWORD);
	...
	@Test
	public void expectedErrorDniIncorrecto() throws Exception {
		JSONObject json = new JSONObject(); 
		json.put("nombre", TEST_NOMBRE);
		json.put("email", TEST_EMAIL);
		json.put("password", TEST_PASSWORD);
	...
	@Test
	public void expectedErrorEmailIncorrecto() throws Exception {
		JSONObject json = new JSONObject();
		json.put("nombre", TEST_NOMBRE);
	...
	@Test
	public void expectedErrorPasswordIncorrecta() throws Exception {
			JSONObject json = new JSONObject();
			json.put("nombre", TEST_NOMBRE);
			json.put("email", TEST_EMAIL);
	...
	@Test
	public void expectedErrorPasswordNoCoincide() throws Exception {
			JSONObject json = new JSONObject();
			json.put("nombre", TEST_NOMBRE);
			json.put("email", TEST_EMAIL);
			json.put("password", "hola");
