...
public class ModificarPacienteApplicationTest {
	@Autowired 
	...
	@Test
	@Order(1)
	public void modificarPacienteCorrecto() throws Exception {
	...
	@Test 
	public void expectedErrorPacienteInexisistente() throws Exception {
		JSONObject json = new JSONObject();
